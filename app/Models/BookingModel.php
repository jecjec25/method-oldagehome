...
class BookingModel extends Model
{
    ...
    protected $allowedFields    = ['lastname', 'outcomes','description','amount_raised','acknowledgement','firstname', 'middlename', 'contactnum', 'event', 'prefferdate', 'alterdate', 'equipment', 'comments', 'status', 'usersignsId' ];

...
class BookingModel extends Model
{
    ...
    protected $allowedFields    = ['lastname', 'outcomes','description','amount_raised','acknowledgement','firstname', 'middlename', 'contactnum', 'event', 'prefferdate', 'Time', 'equipment', 'comments', 'status', 'usersignsId' ];

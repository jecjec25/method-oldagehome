...
exit();
    ...
    {
        $data = [
            'elder' => $this->admissionslip->select('adminsionsliptbl.Id, adminsionsliptbl.Id, adminsionsliptbl.casenum , adminsionsliptbl.birthplace , adminsionsliptbl.nameCom , adminsionsliptbl.addressCom,
            adminsionsliptbl.contactCom , adminsionsliptbl.RelationClient , adminsionsliptbl.nameRef,
             adminsionsliptbl.addressRef , adminsionsliptbl.contactRef , adminsionsliptbl.Num1A , adminsionsliptbl.Num1D , adminsionsliptbl.Num2A 
             , adminsionsliptbl.Num2D , adminsionsliptbl.Num3A , adminsionsliptbl.Num3D , adminsionsliptbl.Num4A , adminsionsliptbl.Num4D
             , adminsionsliptbl.Num5A , adminsionsliptbl.Num5D , adminsionsliptbl.Num6A , adminsionsliptbl.Num6D , adminsionsliptbl.Num7A , adminsionsliptbl.Num7D
             , adminsionsliptbl.Num8A , adminsionsliptbl.Num8D , adminsionsliptbl.Num9A , adminsionsliptbl.Num9D , adminsionsliptbl.Num10A , adminsionsliptbl.Num10D, 
             ...
             , tblscdetails.middlename ,  tblscdetails.nickname , tblscdetails.DateBirth , tblscdetails.gender , tblscdetails.marital_stat 
             , tblscdetails.ContNum , tblscdetails.ComAdd , tblscdetails.ProfPic  , tblscdetails.EmergencyAdd  , tblscdetails.EmergencyContNum 
             , tblscdetails.RegDate , tblscdetails.scstatus , tblscdetails.departuredate , tblscdetails.reasonleft , tblscdetails.datedeath ,tblscdetails.InputedDate , tblscdetails.causedeath , tblscdetails.adminId')
             ->join('tblscdetails', 'tblscdetails.Id = adminsionsliptbl.Id')->where('adminsionsliptbl.Id', $elderData)->first(),

...
<head>
    ...
    <style>
        ...
        body {
            ...
            font-size: 13px;  /* Reduced font size for better fit */
            margin: 0;
            padding: 0;
        ...
        .header img {
            position: absolute;
            left: 100px; /* Adjusted to give space from the left */
            top: 20px;  /* Adjusted to give space from the top */
            height: 100px;  /* Resize the logo to make it more formal */
...
<body>
    ...
    <form action="<?= base_url('generateElderlyReport/' .$search)?>" method="get">
<div class="button-download">
    ...
    <div class="size">
        ...
        <h4 style="text-align: center; font-size:13px;">LIST OF ELDERS</h4>

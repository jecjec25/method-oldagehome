                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            </p> <div class="button-print"><button id="PrintButton" onclick="PrintPage()">Print</button></div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <a href="<?= base_url('reportElder/' .$reg['Id'])?>" class="btn btn-warning btn-sm btn-icon-text mr-3">Report</a>

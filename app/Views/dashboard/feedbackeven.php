      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end" align="right">
        <ul class="navbar-nav mr-lg-2">
          <li class="nav-item ml-0">
            <h4 class="mb-0">Event Feedbacks</h4>
          </li>
          <li class="nav-item">
    ...
    <?php include_once('includes/sidebar.php');?>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <h4 class="card-title" style="padding-left: 20px; padding-top: 20px;">Event Feedbacks</h4>
                  <p class="card-description" style="padding-left: 20px;"> 
                    Event Feedbacks for events of Aruga-Kapatid Foundation Incorporated
                  </p>
                ...
                <div class="table-responsive pt-3">
                  ...
                  <?php if(isset($feeds['id'])){?>
                    ...
                    <tbody>
                    <?php foreach($feedevents as $feeds): ?>
                <tr>

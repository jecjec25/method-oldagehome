            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <h4 class="card-title" style="padding-left: 20px; padding-top: 20px;">Table Report of Left Elders
                                </h4>
                                ...
                                <div class="button-print"><a class="btn btn-primary"
                                        href="<?= base_url('getReportsLeft/' .$fromdate. '/' . $todate ) ?>" id="PrintButton">Print</a>
                                </div>

...
<head>
    <title>Table Report of Left Elders</title>
            ...
            <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end" align="right">
                <ul class="navbar-nav mr-lg-2">
                    <li class="nav-item ml-0">
                        <h4 class="mb-0">Table Report of Left Elders</h4>
                    </li>
                    <li class="nav-item">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <h4 class="card-title" style="padding-left: 20px; padding-top: 20px;">Table Report of Left Elders</h4>
                                ...
                                <div class="table-responsive pt-3">
                                    <table class="table table-striped project-orders-table" id="tblscdetails">
                                        ...
                                        <tbody>
                                            ...
                                            $pagedData = array_slice($Left, $startIndex, $itemsPerPage);
                                            ...
                                            <tr>
                                                ...
                                                <td><?=$k['ContNum'] ?></td>
                                                <td>
                                                    <img src="<?="upload/seniors/" .$k['ProfPic']?>" alt="Senior Image" style="width: 90px;height: 90px; cursor: pointer;" data-toggle="modal" data-target="#profileModal<?=$k['Id']?>">
                                                </td>
                                                <td><?=$k['ComAdd'] ?></td>

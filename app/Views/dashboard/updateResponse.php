            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <tr>
                    ...
                    <td><?=$response['Answers']?></td>
                    <td>
                          <div class="d-flex align-items-center">
                          <a href="<?= base_url("deleteResponse/".$response['id']); ?>" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-danger btn-sm btn-icon-text">Delete <i class="typcn typcn-delete-outline btn-icon-append"></i></a>
                          </div>
                    </td>    
                </tr>
                  <?php endforeach; ?>

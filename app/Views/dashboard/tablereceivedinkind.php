                ...
                <div class="table-responsive pt-3">
                  <table class="table table-striped project-orders-table" id="userbooking">
                    ...
                    <tr>
                      ...
                      <td><?=$item['message'] ?></td>
                      <td>
                        <a href="<?= base_url('deleteReceivedInkind/' . $item['id']) ?>" class="btn btn-danger btn-sm btn-icon-text me-2" onclick="return confirm('Are you sure you want to delete this form?')">

      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end" align="right">
        <ul class="navbar-nav mr-lg-2">
          <li class="nav-item ml-0">
            <h4 class="mb-0">Published News</h4>
          </li>
          <li class="nav-item">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <h4 class="card-title" style="padding-left: 20px; padding-top: 20px;">Published News</h4>
                <p class="card-description" style="padding-left: 20px;">
                  Published News of Aruga Kapatid
                </p>
                    ...
                    <tbody>
                      <?php foreach($main as $news): ?>
                        <tr>
                          ...
                          <td><?=$news['Category'] ?></td>
                          <td>
                            <img src="<?="/upload/news/".$news['picture']?>" style="width:50px; height:50px; border:box;" class="open-modal">
                          </td>
                          <td><?=$news['status'] ?></td>
                          <td>

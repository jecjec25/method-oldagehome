            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="<?= site_url('saveEditdeceased/' .$deceased['Id']) ?>" method="post">
                
                <input type="hidden" name="id" value="<?= $deceased['Id']?>">
            
              <div class="form-group">
                 <label for="datedeath">Date of Death</label>
                <input id="datedeath" name="datedeath" type="date" class="form-control" required="true" value="<?= $deceased['datedeath'] ?>" />
              </div>
              <div class="form-group">
              <label for="causedeath">Cause of Death</label>
              <input id="causedeath" name="causedeath" type="text" class="form-control" required="true" value="<?= $deceased['causedeath'] ?>">
              </div>
              <div class="col-md-12">
                ...
                <br>
                    <div class="col-md-12">
                    <a href="/archivesdeceased" class="btn btn-secondary">Back</a>
                    </div>
                    <br>
                  </form>
                </div>

    ...
    <ul>
        ...
        <?php foreach ($events as $mevents): ?>
            <li>
                ...
                <p><strong>Attachments:</strong><br><img class="sinc" src="<?="/upload/events/" . $mevents['Attachments']?>" alt="eventsba"></p>
                ...
                <form action="<?= base_url('feedback')?>" method="post">
                    ...
                    <textarea disabled name="feedback" cols="60" rows="10" placeholder="Please Login Before you write a Feedback"></textarea>

            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="<?php echo site_url('search/search_keyword');?>" method="post">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            <a href="" class="btn btn-success btn-sm btn-icon-text mr-3">View <i class="typcn typcn-edit btn-icon-append"></i> </a> 
